...
# \title{TESTCASE A - 2-Level 6-Factor Full Factorial (With 30 replicates) - Data Analysis}
# \date{\today}
# \maketitle
...
stats.probplot(y1.iloc[0:-3]['Effects_Estimate'],
               dist="norm", rvalue=True, plot=ax)
plt.show()
