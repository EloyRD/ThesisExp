...
dat = [('pop_s',  10, 160, -1, 1, 'Numerical'),
...
multi_final_fitness_res['s_sel'] = multi_final_fitness_res['s_sel'].replace(
    ['fitness_proportional_selection', 'uniform'], [-1, 1]).infer_objects()
...
multi_final_fitness_res.to_pickle(
    './Data/TEST_A_DOE_data.gz', compression='gzip')
